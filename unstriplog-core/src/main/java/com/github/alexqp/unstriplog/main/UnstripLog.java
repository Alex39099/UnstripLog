...
public class UnstripLog extends JavaPlugin implements Debugable {
    ...
    private static String getInternalsName(String minecraftVersion) {
        if (minecraftVersion.startsWith("1.13") || minecraftVersion.startsWith("1.14") || minecraftVersion.startsWith("1.15")) {
        ...
        } else if (minecraftVersion.startsWith("1.17") || minecraftVersion.startsWith("1.18")) {
            // renamed GRASS_PATH to DIRT_PATH, added ROOTED_DIRT
            return "Internals_v1_18_2";
        } else if (minecraftVersion.startsWith("1.19")) {
            // added mangrove wood
            return "Internals_v1_19_4";
        }
